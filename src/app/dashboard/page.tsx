...
import StatusDrowdown from "./StatusDropdown";
              ...
              {order.map((order) => (
                <TableRow key={order.id} className="bg-accent">
                  ...
                  <TableCell className="hidden sm:table-cell">
                    <StatusDrowdown id={order.id} orderStatus={order.status} />
                  </TableCell>
                  <TableCell className="md:table-cell">{order.createdAt.toLocaleDateString()}</TableCell>
