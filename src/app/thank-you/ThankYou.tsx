        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              We at CaseCustom believe that a phone case doesn't only need to look good, but also last you for the years to come. We offer a 4-year print guarantee: If you case isn't of the highest quality, we'll replace it for free.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-x-6 border-t border-zinc-200 py-10 text-sm">
            <div>
              ...
              <p className="mt-2 text-primary">paid</p>
            </div>
            <div>
              <p className="font-medium text-zinc-900">Shipping method</p>
              <p className="mt-2 text-zinc-700">
                <span className="text-red-500 font-medium">SiCepat</span>, takes up to 3 working days
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6 border-t border-zinc-200 pt-10 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <div className="text-right">
              <p className="line-through text-zinc-500">{formatPrice(15000)}</p>
