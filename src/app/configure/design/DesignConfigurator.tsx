      ...
      >
        <div className="relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831]">
          <AspectRatio ref={phoneCaseRef} ratio={896 / 1831} className="pointer-events-none relative z-50 aspect-[896/1831] w-full">
            <Image alt="phone image" src="/phone-template.png" fill className="pointer-events-none z-50 select-none" />
          </AspectRatio>
        ...
        >
          <div className="relative w-full h-full">
            <Image alt="image user" src={imageUrl} fill className="pointer-events-none" />
          </div>
        </Rnd>
      </div>

      <div className="h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white">
        <ScrollArea className="raltive flex-1 overflow-auto">
                        ...
                        >
                          <span className="flex items-center">
                            <span className="flex flex-col text-sm">
                              <RadioGroup.Label className="text-medium text-gray-900" as="span">
                                {option.label}
                              </RadioGroup.Label>
